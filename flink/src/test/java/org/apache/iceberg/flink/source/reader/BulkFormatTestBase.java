...
public abstract class BulkFormatTestBase {
  ...
  public void before() throws IOException {
    ...
    dataAppender = new GenericAppenderHelper(table, getFileFormat(), TEMPORARY_FOLDER);
  ...
  public void testNoCheckpointedPosition() throws IOException {
    final BulkFormat.Reader<RowData> reader = getBulkFormat().createReader(flinkConfig, icebergSplit);
  ...
  public void testCheckpointedPositionBeforeFirstFile() throws IOException {
    ...
    final BulkFormat.Reader<RowData> reader = getBulkFormat().restoreReader(flinkConfig, checkpointedSplit);
