 ...
 */
public interface RecordsWithSplitIds<E> extends org.apache.flink.connector.base.source.reader.RecordsWithSplitIds<E> {
  /**
  ...
  @Override
  default Collection<String> splitIds() {
    return null;
  }

  @Override
  default Map<String, Collection<E>> recordsBySplits() {
    return null;
  }
}
