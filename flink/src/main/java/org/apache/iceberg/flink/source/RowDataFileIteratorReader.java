...
public class RowDataFileIteratorReader implements FileIteratorReader<RowData> {
  ...
  public RowDataFileIteratorReader(Schema tableSchema, Schema projectedSchema,
  ...
  public CloseableIterator<RowData> open(FileScanTask task, DecryptedInputFiles decryptedInputFiles) {
    ...
    CloseableIterator<RowData> iterator = deletes
